...
کتاب راهنمای همراه طراحان و توسعه دهندگان وب فارسی

سلام، به وب نامه خوش آمدید.
وب نامه راهنمای همراه طراحان و توسعه دهندگان وب به زبان فارسی است.
تلاش این پروژه این است که بتواند راهکارهایی سریع و عملی برای مشکلات و چالش های کار در وب ارائه کند.



برای مثال اگر می خواهید جاوا اسکریپت یاد بگیرید باید چه کنید و کجا مراجعه کنید؟ برای معماری اپلیکیشن های خود چه راهکارهایی وجود دارد. 
چه جریان کاری باید در طراحی و توسعه یک وب سایت دنبال شود. کجا باید به دنبال کتابخانه های مفید بود؟ و ...
...
### شروع فرآیند طراحی - Design Process Kick-Off
مهمترین موضوع _درک دقیق_ از پروژه است. برای این موضوع باید به موارد زیر توجه کرد
1. خروجی ها و Deliverables
2. استایل کلی طراحی
3. الزامات محیط توسعه
4. محدودیت ها: فریمورک ها و سی ام اس 
